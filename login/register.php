...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($input_username)) {
        ...
        if (strlen($input_username) < 3 || strlen($input_username) > 10) {
            $errors[] = "Username must be 3-10 characters long.";
        }
    ...
    <script>
        ...
        function validateUsername(input) {
            ...
            if (username && touched.username) {
                if (username.length < 3 || username.length > 10) errors.push("Username must be 3-10 characters long.");
